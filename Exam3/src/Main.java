...
//Employee should be abstract. What is abstract?
...
class TestSchoolRecords {
    ...
    public static void main(String[] args) {
        ...
        // Add 2 faculty
        persons.add(new Faculty("Dr. Evil", "789 Ash Ct", "111-222-3333", "dr.evil@iamgreat.xyz", "World Studies", 6000.0, "2023-01-15", "Monday 2-4pm", "Senior"));
        persons.add(new Faculty("Prof. Proton", "321 Pine St", "444-555-6666", "prof.proton@pbs.com", "Physics", 5500.0, "2022-08-20", "Wednesday 10am-12pm", "Junior"));

        // Add 2 staff
        persons.add(new Staff("Alan Parsons", "555 Cedar St", "777-888-9999", "alanparson@harvard.edu", "Administration", 4500.0, "2024-03-01", "Administrative Assistant"));
        persons.add(new Staff("Bob Barker", "999 Maple St", "222-333-4444", "bob.barker@gmail.com", "Library", 4000.0, "2023-11-10", "Librarian"));
        ...
        // Filtering and outputting employees
